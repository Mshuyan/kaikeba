...
//        properties.put("retry.backoff.ms", 100);// 两次重试之间的时间间隔 默认为100ms
    ...
    public void sendMsg() throws Exception{
        ...
        /**
         * 发送消息的时候修改ProducerRecord中的timestamp的值来是其变得超时。
         */
        ProducerRecord<Integer, String> record1 = new ProducerRecord<>("cities", 0,
        ...
        ProducerRecord<Integer, String> record2 = new ProducerRecord<>("cities", 0,
        ...
        ProducerRecord<Integer, String> record3 = new ProducerRecord<>("cities", 0,
